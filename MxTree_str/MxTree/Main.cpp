...
int objs;
int dimension = 78;
string path = "H:\\EP\\DB\\DBLP\\authors3.txt";
string BitMapPath = "H:\\EP\\INDEX\\DBLP\\MXTREE\\BitMap_DBLP.txt";
string MXTreePath = "H:\\EP\\INDEX\\DBLP\\MXTREE\\MXTREE_DBLP";
int amount = 1162047;

int MAX_ENTRY_NUM = 430;
