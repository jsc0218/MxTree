...
//string BitMapPath = "E:\\EP\\INDEX\\Dimensionality & Radius\\UNIFORM\\MXTREE_SLIM\\BitMap_50_100.txt";
//string MXTreePath = "E:\\EP\\INDEX\\Dimensionality & Radius\\UNIFORM\\MXTREE_SLIM\\MXTREE_50_100";
string path = "H:\\20-100.txt";
string BitMapPath = "H:\\BitMap_20_100.txt";
string MXTreePath = "H:\\MXTREE_20_100";
int amount = 1000000;
...
int main()
{
	...
	for (int i=0; i<amount/1000; i++) {
		...
		SimpleQuery query(pred, 0.89442719099992);
		delete pred;
